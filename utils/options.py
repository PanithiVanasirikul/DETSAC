...
def get_options():
    ...
    parser.add_argument('--encoder_layers', default=3, type=int, help='number of residual blocks')
    parser.add_argument('--decoder_layers', default=3, type=int, help='number of transformer decoder blocks')
    parser.add_argument('--nheads', default=4, type=int, help='number of transformer decoder blocks')
    parser.add_argument('--dim_feedforward', default=128, type=int, help='number of transformer decoder blocks')
